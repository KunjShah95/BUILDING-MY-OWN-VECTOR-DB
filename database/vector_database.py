...
class VectorDatabase:
        ...
        try:
            ...
            if self.is_indexed and use_index:
                ...
                results = self.vector_model.search_vectors(
                    query_vector.tolist(), k, distance_metric
                )
    ...
    def _search_indexed(
        self, query_vector: np.ndarray, k: int = 5, n_probes: int = 10
    ) -> List[Dict[str, Any]]:
        """
        ...
        for result in results:
            ...
            if vector:
                result["metadata"] = vector.meta_data
    ...
    def get_vector(self, vector_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "message": f"Error retrieving vector: {str(e)}"}
    ...
    def get_all_vectors(self, limit: int = 1000, offset: int = 0) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "message": f"Error retrieving vectors: {str(e)}"}
    ...
    def get_index_info(self) -> Dict[str, Any]:
        ...
        if not self.is_indexed:
            return {"success": False, "message": "No index created yet"}
    ...
    def get_vector_metadata_fields(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "metadata_fields": list(all_fields)}
        except Exception as e:
            return {
                "success": False,
    ...
    def rebuild_index(self, k: int = 100) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "message": f"Error rebuilding index: {str(e)}"}
